...
const BuyerPage = () => {
  ...
  const productNavigate=(deals)=>{
    navigate("/propertydetails",{state:{productDet:deals}})
    }
...
const discountPrice=(old_price,discount)=>{
  ...
  return (
    ...
    <h3 style={{marginLeft:"680px"}}>Buyer Panel</h3>
    ...
    <div  className='product-card-container'>
      {deals.map((deal)=>(
        ...
        <button className='btn btn-primary admin-logout-button' style={{width:"180px",marginLeft:"33px"}} onClick={()=>productNavigate(deal)}>I'm Interested</button>
